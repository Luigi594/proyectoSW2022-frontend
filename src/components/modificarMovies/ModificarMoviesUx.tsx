        ...
        <form action="https://formbold.com/s/FORM_ID" method="POST">
          ...
          <div className="mb-5">
            ...
            <textarea
              ...
              className="w-full resize-none rounded-md border border-[#C0C0C0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"></textarea>
          </div>
