...
function MoviesUx({
  ...
  return (
    <div className="max-w-7xl">
      ...
      <div className="flex flex-col items-center justify-evenly mt-10 md:flex-row">
        {data &&
          data.items.map((item: IPeliculas) => (
            <div
              key={item._id}
              className="max-w-sm rounded-lg shadow-md bg-gray-700 border-gray-700">
              <img
              ...
              <div className="p-5 space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-lg text-white">Añadir a favoritos</p>
                  </div>
